...
//server error resonse codes
    ...
    export const PUBLIC_LOCATION = '/Users/dylancorbus/Desktop/spotback-repos/matching-service(v2)/resources/public.pem';
    export const PRIVATE_LOCATION = '/Users/dylancorbus/Desktop/spotback-repos/matching-service(v2)/resources/private.pem';
